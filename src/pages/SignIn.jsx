      ...
      <div className="relative w-full max-w-md bg-white/90 backdrop-blur-sm rounded-3xl border border-gray-200 shadow-sm p-8 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-blue-600 text-white text-sm font-bold rounded-full hover:bg-blue-700 active:scale-95 transition-all"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="ml-1 text-blue-600 font-semibold hover:underline">
              Sign up
            </Link>
          </div>
